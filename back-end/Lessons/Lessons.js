const lessons = [
    ...
    {content: 
        [
            ...
            {content: 1, contentText: "On the other hand, cryptocurrencies have no intrinsic value as they are not backed by underlying assets or earnings. There are thousands of cryptocurrencies to choose from, and each of them are decentralized. In some cases, this creates volatility as they are not regulated. In some cases, countries such as China have banned crypto in hopes of keeping a regulated finance system. "},
            ...
            {content: 2, contentText: "A blockchain collects information in groups (called blocks), where each block has a certain  storage capacity. Different types of information can be stored on a blockchain, but the most common use is a ledger for transactions. Each transaction is recorded with a cryptographic signature called a hash. As such, if one block is changed (a transaction is made), it would be clear to see from the block history."},
            ...
            {content: 3, contentText: "To note: Owning a cryptocurrency does not mean owning the coin. As an owner of cryptocurrency, you do not own anything tangible. Instead, you own a key that allows you to move a record from one person to another without having to go through an institution such as a bank. "},
            ...
            {content: 16, contentText: "Content Text"},
            {content: 17, contentText: "Content Text"},
            {content: 18, contentText: "Content Text"},
