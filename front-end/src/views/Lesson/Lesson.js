...
function Lesson() {
    ...
    useEffect(() => {
        ...
        async function getCurrentLesson() {
            const res = await fetch(`http://localhost:4000/lesson/${lessonID}`);
        ...
        <div id="page-content">
            ...
            <div id="lesson-quiz">
                ...
                <div id="lesson-buttons">
                        <input id="prevButton" className="imageButton" type="image" src="http://localhost:4000/static/left-arrow.png" onClick={prevQuestion}></input> 
                        {(complete ? (
                        ...
                        <input id="nextButton" className="imageButton" type="image" src="http://localhost:4000/static/right-arrow.png" onClick={nextQuestion}></input> 
                </div>
            </div>
            <div id="map-button">
