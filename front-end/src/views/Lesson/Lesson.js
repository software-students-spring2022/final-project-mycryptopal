      ...
      <div id="page-content">
        ...
        <div id="lesson-quiz">
          ...
          <div id="lesson-buttons">
            <input id="prevButton" className="imageButton" type="image" alt="Left Arrow" src={`${process.env.REACT_APP_BACKEND_URL}/static/left-arrow.png`} onClick={prevQuestion}></input>
            {(complete ? (
            ...
            <input id="nextButton" className="imageButton" type="image" alt="Right Arrow" src={`${process.env.REACT_APP_BACKEND_URL}/static/right-arrow.png`} onClick={nextQuestion}></input>
          </div>
        </div>
        <div id="map-button">
